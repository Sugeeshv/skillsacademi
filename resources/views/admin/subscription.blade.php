                            ...
                            <div class="row heading">
                                <div class="col-md-6">
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            <p>Newsletter subscriber list will be displayed here</p>
                                        </td>
                                    </tbody>
                                </table>
                                </div>
                                <div class="col-md-6">
                                    <div class="d-flex">
                                        <div class="ml-auto"><a href="#" class="secondary-btn"><i class="fa fa-download" aria-hidden="true"></i> Export List</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                            ...
                                            <table id="table_id">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><div class="nametag">Active</div></td>
                                                        <td>{{$sub->created_at}}</td>
                                                        <td>
                                                            <ul>
                                                                <li>
                                                                    @csrf
                                                                    <a href="{{ url('/subscription-delete/'.$sub->id) }}" onclick="return confirm('Are You Sure ?')"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                                </li>
                                                            </ul>
                                                        </td>
                                                    </tr>
