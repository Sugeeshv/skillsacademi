                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form method="post" action="{{ url('cookie_policy_save') }}" enctype="multipart/form-data">
                        <div class="row">
                            <div class="col-lg-12">
                                            ...
                                            <div class="col-md-12">
                                                @csrf
                                                    <div class="form-group">
                                                        <textarea name="description"  id="summernote" cols="20" rows="5" class="form-control"> {!! $Cookie->content !!} </textarea>
