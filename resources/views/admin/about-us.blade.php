                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="jsad-body-layout-box">
                                    <div class="padding">
                                                <form method="post" action="{{ url('about-save') }}" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                    @csrf
                                                        <div class="form-group">
                                                            <textarea class="summernote" id="summernote" name="description">{!! $about->description !!}</textarea>
                                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="d-flex">
                                                    <div class="ml-auto"><button class="btns btn-green">Save</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
