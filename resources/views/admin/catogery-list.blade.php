            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row heading">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex">
                                <div class="ml-auto"><a href="{{url('blog-catogery')}}" class="secondary-btn">
                            ...
                            <div class="jsad-body-layout-box">
                                <div class="padding">
                                    <table id="table_id">
                                        ...
                                        <tbody> @foreach ($blogcatogerys as $blog) 
                                            <tr>
                                                <td>{{$blog->id}}</td>
                                                <td>{{$blog->catogery_name}}</td>
                                                ...
                                                <td>
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="{{url('blog-catogery-update/'.$blog->id)}}"> <i class="fa fa-pencil"
                                                                    aria-hidden="true"></i></a>
                                                        </li>
                                                        <li>
                                                            @csrf
                                                            <a href="{{ url('/blog-catogery-delete/'.$blog->id) }}" onclick="return confirm('Are You Sure ?')"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                                    </ul>
                                                </td>
                                            </tr>         
                                                @endforeach          
