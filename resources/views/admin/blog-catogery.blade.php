                    ...
                    <div class="row display-flex">
                        <div class="col-lg-8">
                            <div class="jsad-body-layout-box">
                                <div class="padding">
                                    <br>
                                    <form class="needs-validation form-sp-style" method="post" action="{{url('blog-catogery-save')}}">
                                        @csrf
                                                <div class="form-group">
                                                    <input id="catogeryname" type="text" name="catogeryname" class="blackcolor-text input-orange" id="usr" value="" placeholder="Category Name" autocomplete="off" required>
