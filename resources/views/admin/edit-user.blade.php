        ...
        <div class="jsad-body-layout">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form method="POST" action="{{route('users.update', $user->id)}}" class="form-sp-style" novalidate>
                        @method('PATCH')
                        @csrf
                            ...
                            <div class="col-lg-8">
                                <div class="jsad-body-layout-box">
                                    <div class="padding">
                                        ...
                                        <div class="form-group">
                                            <input name="{{$user->phonenumber}}" type="text" class="form-control" placeholder="Phone Number" autocomplete="off"
                                                id="usr" required>
                                            <label for="usr"></label>
                                        ...
                                        <div class="form-group">
                                            <!-- <input id="validationTooltip01" type="text" class="form-control" id="usr" required> -->
                                            <input name="email" type="text" class="form-control" placeholder="Email address" autocomplete="off" value="{{$user->email}}"
                                                id="usr" required>
                                            <label for="usr"></label>
                                            <div class="small-text">Choose appropriate user role. </div>
                                            <div class="invalid-feedback">
                                ...
                                <div class="jsad-body-layout-box">
                                    <div class="padding">
                                        <div class="profile-pic">
                                            <img class="w-100" src="./images/profile.png" alt="">
                                            <div class="input-profile-pic-uplade">
                                                <input type="file" class="profile-pic-input" placeholder="">
