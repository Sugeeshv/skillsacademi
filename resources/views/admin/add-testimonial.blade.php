                        ...
                        <div class="row">
                            <div class="col-md-12 ">
                                <div class="jsad-body-layout-box">
                                    ...
                                    <div class="col-lg-8">
                                        <br>
                                        <form class="needs-validation form-sp-style" method="post" action="{{url('testimonial-add/')}}">
                                            @csrf
                                            <div class="form-group">
                                                <input id="name" name="name" type="text" name="catogeryname" class="blackcolor-text input-orange" value=""  placeholder="Enter Name" autocomplete="off" required="">
                                                <div class="invalid-feedback">
                                                    Please fill out this field
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <textarea id="summernote" name="description" type="text" name="catogeryname" class="" value=""  placeholder="Enter Name" autocomplete="off" required=""></textarea>
                                                <div class="invalid-feedback">
                                                    Please fill out this field
                                                </div>
                                            </div>
