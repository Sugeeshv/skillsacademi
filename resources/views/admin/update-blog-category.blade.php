                        ...
                        <div class="col-lg-8">
                            <div class="jsad-body-layout-box">
                                <div class="padding">
                                    ...
                                    @foreach ($blogcategorys as $blog) 
                                    <form method="post" action="{{url('blog-catogery-update-save/'.$blog->id)}}">
                                        @csrf
                                        <input type="hidden" value="{{$blog->id}}">
                                        <div class="form-group">
                                            <input id="catogeryname" type="text" name="catogeryname" class="blackcolor-text input-orange" id="usr" value="{{$blog->category_name}}" placeholder="Category Name" autocomplete="off" required>
