                        ...
                        <div class="row display-flex">
                            <div class="col-lg-12">
                                <div class="jsad-body-layout-box">
                                    <div class="padding">
                                        <br>
                                        <form class="role-form form-sp-style" method="POST" action="{{ route('roles.update', $role->id) }}" novalidate>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="text" name="name" placeholder="Enter Role Name"
                                                            class="form-control" value="{{$role->name}}" id="usr"
                                                            value="" required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input name="permission[]" type="text" class="form-control"
                                                            placeholder="Enter Description" id="usr" value="" required>
